    ...
    public RouteLocator loadBalancedRoutes(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("voucher-service", r -> r.path("/api/v1/voucher","/api/v1/voucher/**",
                                "/api/v1/batch", "/api/v1/batch/**",
                                "/api/v1/cluster", "/api/v1/cluster/**").uri("lb://voucher-server"))
                .route("provider-service", r -> r.path("/api/v1/provider", "/api/v1/provider/**",
                                "/api/v1/recharge", "/api/v1/recharge/**",
                                "/api/v1/serviceprovider", "/api/v1/serviceprovider/**",
                                "/api/v1/auth-recharge", "/api/v1/auth-recharge/**").uri("lb://provider-server"))
